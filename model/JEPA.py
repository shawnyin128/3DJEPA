...
from utils.loss_utils import variance_term, covariance_term, correlation_term, vic_loss
...
class JEPAModel(nn.Module):
    ...
    def forward(self, images, actions):
        ...
        stats = {
            ...
            "corr_online": torch.tensor(corr_online_sum / max(num_steps, 1), device=images.device),
            "corr_target": torch.tensor(corr_target_sum / max(num_steps, 1), device=images.device),
        }
